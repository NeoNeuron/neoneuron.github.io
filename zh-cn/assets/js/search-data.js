...
const siteUrl = "https://kchen513.top"; 
let updatedUrl = currentUrl.replace("https://kchen513.top", "");
...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "近期动态",},{id: "news-新海报入选第四届神经计算青年研讨会",
          title: '新海报入选第四届神经计算青年研讨会',
          description: "",
          section: "近期动态",handler: () => {
              window.location.href = "/zh-cn/news/2025-01-SYNCB_poster/";
            },},{id: "news-我通过了博士答辩-tada",
          title: '我通过了博士答辩。 :tada:',
          description: "",
          section: "近期动态",},{id: "news-我获得了应用数学博士学位-tada",
          title: '我获得了应用数学博士学位。 :tada:',
          description: "",
          section: "近期动态",},{id: "news-我加入巴黎高等师范学院开展新的博士后研究工作",
          title: '我加入巴黎高等师范学院开展新的博士后研究工作。',
          description: "",
          section: "近期动态",},{id: "news-我们的最新工作-emergent-hierarchical-representations-for-multi-task-learning-in-anatomy-constrained-rnns-已被接受为-cosyne-2026-的海报展示-tada",
          title: '我们的最新工作 Emergent hierarchical representations for multi-task learning in anatomy-constrained RNNs 已被接受为 COSYNE 2026...',
          description: "",
          section: "近期动态",},{id: "news-我们的最新论文-anatomical-connectivity-reconstruction-of-biological-neuronal-networks-using-granger-causality-已被-neural-networks-接收为研究文章-tada",
          title: '我们的最新论文 Anatomical Connectivity Reconstruction of Biological Neuronal Networks Using Granger Causality 已被 Neural...',
          description: "",
          section: "近期动态",},{
        id: 'social-email',
        title: '发邮件',
